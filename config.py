...
# Force Subscription (liste dans une seule variable)
FSUBS = eval(os.getenv("FSUBS", "[[-1003016571084, True, 10]]"))

DB_CHANNEL = os.getenv("DB_CHANNEL", "")
AUTO_DEL = int(os.getenv("AUTO_DEL", 300))

ADMINS = [int(x) for x in os.getenv("ADMINS", "6497757690,6103092779").split(",")]
DISABLE_BTN = os.getenv("DISABLE_BTN", "True").lower() == "true"
PROTECT = os.getenv("PROTECT", "True").lower() == "true"
...
MESSAGES = {
    ...
    "FSUB": "<b><blockquote>›› ʜᴇʏ ×</blockquote>\n  ʏᴏᴜʀ ғɪʟᴇ ɪs ʀᴇᴀᴅʏ ‼️ ʟᴏᴏᴋs ʟɪᴋᴇ ʏᴏᴜʜᴀᴠᴇɴ'ᴛ sᴜʙsᴄʀɪʙᴇᴅ ᴛᴏ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ʏᴇᴛ, sᴜʙsᴄʀɪʙᴇ ɴᴏᴡ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇs</b>",
